            ...
            <div className="skills-grid">
              ...
              <div className="skill-category">
                ...
                <div className="skill-list">
                  ...
                  <i className="fas fa-project-diagram"></i> Multi-Agent Orchestration • <i className="fas fa-fire"></i>{" "}
                  PyTorch • <i className="fab fa-apple"></i> Core ML • <i className="fas fa-cube"></i> MLX •{" "}
                  <i className="fas fa-image"></i> Stable Diffusion • <i className="fas fa-cog"></i> LoRA •{" "}
                  <i className="fas fa-robot"></i> OpenAI APIs • <i className="fas fa-robot"></i> Claude API •{" "}
                  <i className="fas fa-palette"></i> ChromaDB • <i className="fas fa-tree"></i> Pinecone •{" "}
                  <i className="fas fa-search"></i> Qdrant • <i className="fas fa-search"></i> Semantic Search •{" "}
                  <i className="fas fa-eye"></i> Computer Vision • <i className="fas fa-comments"></i> NLP •{" "}
                  <i className="fas fa-microphone"></i> Speech Processing
                </div>
              </div>
              ...
              <div className="skill-category">
                ...
                <div className="skill-list">
                  ...
                  <i className="fas fa-plug"></i> Webhooks • <i className="fas fa-cogs"></i> Business Process Automation
                </div>
              </div>
              ...
              <div className="skill-category">
                ...
                <div className="skill-list">
                  ...
                  <i className="fas fa-universal-access"></i> Accessibility • <i className="fas fa-tachometer-alt"></i>{" "}
                  Performance Profiling • <i className="fas fa-flag"></i> Feature Flagging •{" "}
                  <i className="fas fa-sync"></i> Agile/Scrum • <i className="fas fa-file-alt"></i> Technical
                  Documentation
                </div>
              </div>
            </div>
