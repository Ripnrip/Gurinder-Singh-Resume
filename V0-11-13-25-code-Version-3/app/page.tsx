          ...
          <aside className="sidebar">
            ...
            <div className="sidebar-section">
              ...
              <div className="skill-pills">
                ...
                <span className="skill-pill">
                  <i className="fab fa-apple"></i> iOS SDK
                </span>
                <span className="skill-pill">
            ...
            <div className="sidebar-section">
              ...
              <div className="skill-pills">
                ...
                <span className="skill-pill">
                  <i className="fas fa-filter"></i> RAG
                </span>
                <span className="skill-pill">
                ...
                <span className="skill-pill">
                  <i className="fas fa-server"></i> MCP
                </span>
                <span className="skill-pill">
                  <i className="fas fa-fire"></i> PyTorch
                </span>
                <span className="skill-pill">
                  <i className="fas fa-image"></i> SD
                </span>
                <span className="skill-pill">
                  <i className="fas fa-cog"></i> LoRA
                </span>
              </div>
            </div>
              ...
              <div className="skills-grid">
                <div className="skill-category">
                  ...
                  <div className="skill-list">
                    <i className="fab fa-swift"></i> Swift • <i className="fab fa-swift"></i> SwiftUI •{" "}
                    <i className="fab fa-apple"></i> Objective-C • <i className="fab fa-python"></i> Python •{" "}
                    <i className="fab fa-js"></i> JavaScript • <i className="fab fa-js"></i> TypeScript •{" "}
                    <i className="fab fa-node"></i> Node.js • <i className="fab fa-react"></i> React •{" "}
                    <i className="fas fa-arrow-right"></i> Next.js • <i className="fab fa-react"></i> React Native •{" "}
                    <i className="fab fa-flutter"></i> Flutter/Dart • <i className="fas fa-bolt"></i> FastAPI •{" "}
                    <i className="fas fa-cloud"></i> Vapor • <i className="fas fa-server"></i> Express.js •{" "}
                    <i className="fas fa-network-wired"></i> GraphQL • <i className="fas fa-exchange-alt"></i> REST APIs
                  </div>
                </div>
                ...
                <div className="skill-category">
                  ...
                  <div className="skill-list">
                    <i className="fas fa-link"></i> LangChain • <i className="fas fa-book"></i> LlamaIndex •{" "}
                    <i className="fas fa-filter"></i> RAG Pipelines • <i className="fas fa-server"></i> MCP Servers •{" "}
                    <i className="fas fa-project-diagram"></i> Multi-Agent Orchestration •{" "}
                    <i className="fas fa-fire"></i> PyTorch • <i className="fab fa-apple"></i> Core ML •{" "}
                    <i className="fas fa-cube"></i> MLX • <i className="fas fa-image"></i> Stable Diffusion •{" "}
                    <i className="fas fa-cog"></i> LoRA • <i className="fas fa-robot"></i> OpenAI APIs •{" "}
                    <i className="fas fa-robot"></i> Claude API • <i className="fas fa-palette"></i> ChromaDB •{" "}
                    <i className="fas fa-tree"></i> Pinecone • <i className="fas fa-search"></i> Qdrant •{" "}
                    <i className="fas fa-search"></i> Semantic Search • <i className="fas fa-eye"></i> Computer Vision •{" "}
                    <i className="fas fa-comments"></i> NLP • <i className="fas fa-microphone"></i> Speech Processing
                  </div>
                </div>
                ...
                <div className="skill-category">
                  ...
                  <div className="skill-list">
                    <i className="fas fa-mobile-alt"></i> iOS SDK • <i className="fas fa-mobile-alt"></i> UIKit •{" "}
                    <i className="fas fa-bolt"></i> ActivityKit • <i className="fas fa-th"></i> WidgetKit •{" "}
                    <i className="fas fa-circle"></i> Dynamic Island • <i className="fas fa-vr-cardboard"></i> ARKit •{" "}
                    <i className="fas fa-database"></i> Core Data • <i className="fas fa-location-arrow"></i> Core
                    Location • <i className="fas fa-microchip"></i> On-Device ML • <i className="fas fa-database"></i>{" "}
                    SwiftData • <i className="fas fa-database"></i> Realm • <i className="fas fa-link"></i> Combine •{" "}
                    <i className="fas fa-link"></i> RxSwift • <i className="fas fa-vial"></i> XCTest •{" "}
                ...
                <div className="skill-category">
                  ...
                  <div className="skill-list">
                    <i className="fab fa-aws"></i> AWS (Lambda, S3, SageMaker, DynamoDB) •{" "}
                    <i className="fab fa-google"></i> GCP (Vertex AI, Cloud Functions, BigQuery, Firebase) •{" "}
                    <i className="fab fa-microsoft"></i> Azure (AI Services, Functions) •{" "}
                    <i className="fas fa-database"></i> Supabase • <i className="fab fa-docker"></i> Docker •{" "}
                    <i className="fas fa-dharmachakra"></i> Kubernetes • <i className="fas fa-bolt"></i> Serverless
                  </div>
                </div>
                ...
                <div className="skill-category">
                  ...
                  <div className="skill-list">
                    <i className="fas fa-database"></i> PostgreSQL • <i className="fas fa-leaf"></i> MongoDB •{" "}
                    <i className="fas fa-bolt"></i> Redis • <i className="fas fa-database"></i> Vector Databases •{" "}
                    <i className="fas fa-table"></i> Pandas • <i className="fas fa-calculator"></i> NumPy •{" "}
                    <i className="fas fa-chart-bar"></i> Feature Engineering • <i className="fas fa-flask"></i> A/B
                    Testing • <i className="fas fa-chart-line"></i> Data Architecture •{" "}
                ...
                <div className="skill-category">
                  ...
                  <div className="skill-list">
                    <i className="fas fa-infinity"></i> CI/CD (GitHub Actions, Jenkins, Fastlane) •{" "}
                    <i className="fab fa-docker"></i> Docker • <i className="fab fa-git-alt"></i> Git •{" "}
                    <i className="fas fa-dog"></i> DataDog • <i className="fas fa-play"></i> Playwright •{" "}
                    <i className="fas fa-hand-pointer"></i> Puppeteer • <i className="fas fa-project-diagram"></i> n8n •{" "}
                    <i className="fas fa-plug"></i> Webhooks • <i className="fas fa-cogs"></i> Business Process
                    Automation
                  </div>
                </div>
                ...
                <div className="skill-category">
                  ...
                  <div className="skill-list">
                    <i className="fab fa-figma"></i> Figma • <i className="fas fa-palette"></i> ComfyUI •{" "}
                    <i className="fas fa-image"></i> Stable Diffusion • <i className="fas fa-film"></i> FFmpeg •{" "}
                    <i className="fas fa-volume-up"></i> ElevenLabs • <i className="fas fa-microphone"></i> Whisper-MLX
                    • <i className="fas fa-music"></i> Audio/Visual Generation Pipelines
                  </div>
                </div>
                ...
                <div className="skill-category">
                  ...
                  <div className="skill-list">
                    <i className="fas fa-vial"></i> TDD • <i className="fas fa-camera"></i> Snapshot Testing •{" "}
                    <i className="fas fa-desktop"></i> UI Testing • <i className="fas fa-cube"></i> SonarQube •{" "}
                    <i className="fas fa-universal-access"></i> Accessibility •{" "}
                    <i className="fas fa-tachometer-alt"></i> Performance Profiling • <i className="fas fa-flag"></i>{" "}
                    Feature Flagging • <i className="fas fa-sync"></i> Agile/Scrum • <i className="fas fa-file-alt"></i>{" "}
              ...
              <div className="experience-item">
                ...
                <div className="item-details">
                  <ul>
                    ...
                    <li>
                      Developed AI-powered crash detection system using LangChain + DeepLake – now adopted org-wide
                    </li>
                    ...
                    <li>
                      Filed "Interface Widget Tool for Automatic QR Code Generation" patent (2022) – Reduced user
                      friction by 66%
                    </li>
              ...
              <div className="projects-grid">
                <div className="project-card">
                  ...
                  <div className="project-description">
                    Advanced iOS application leveraging on-device ML models for real-time image generation and
                    processing. Built custom Swift wrappers around MLX framework for optimized inference on Apple
                    Silicon, achieving sub-second generation times for 512×512 images.
                  </div>
                </div>
              ...
              <div className="experience-item">
                <div className="item-details">
                  <ul>
                    ...
                    <li>
                      <strong>Devcamp NYC (2016) – 1st Place:</strong> Talent Management App – Won among 300+
                      participants at Google NYC.
                    </li>
                    <li>
                      <strong>HackZurich (2018) – Finalist:</strong> AR Car Buying Tool – Finalist among 400+. Featured
                      in Credit Suisse interview. Attended HackZurich 4×
                    </li>
                    <li>
